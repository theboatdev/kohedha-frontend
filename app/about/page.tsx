...
const C = {
  bg: "#ffffff", bg2: "#DDD9CE", text: "#2A2620", //E8E4DA
    ...
    <div className="font-dm-sans" style={{ background: C.bg, color: C.text, minHeight: "100vh" }}>
      ...
      <section style={{ padding: "100px 48px" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          ...
          <h1 className="font-dm-serif" style={{ fontSize: "42px", letterSpacing: "-0.02em", color: C.text, marginBottom: "48px" }}>
      ...
      <section style={{ background: "black", padding: "100px 48px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <h2 className="font-dm-serif" style={{ fontSize: "42px", letterSpacing: "-0.02em", color: "white", marginBottom: "56px", maxWidth: "480px" }}>
          ...
          >
            {[
              ...
              >
                <div style={{ width: "40px", height: "40px", borderRadius: "10px", background: "rgba(196,114,74,0.12)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "20px", color: C.accent }}>
                  <Icon size={18} />
                </div>
                <div className="font-dm-serif" style={{ fontSize: "22px", color: C.text, marginBottom: "12px" }}>{title}</div>
      ...
      <section style={{ padding: "100px 48px" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          ...
          <h2 className="font-dm-serif" style={{ fontSize: "42px", letterSpacing: "-0.02em", color: C.text, marginBottom: "24px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "16px", marginBottom: "56px" }}>
            {[
              ...
              <div key={title} style={{ background: C.cream, borderRadius: "16px", padding: "32px", border: "1px solid rgba(42,38,32,0.06)" }}>
                ...
                <div className="font-dm-serif" style={{ fontSize: "20px", color: C.text, marginBottom: "10px" }}>{title}</div>
