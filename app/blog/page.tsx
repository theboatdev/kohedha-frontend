    ...
    <div className="font-dm-sans" style={{ background: C.bg, color: C.text, minHeight: "100vh" }}>
      ...
      <section style={{ padding: "72px 48px", maxWidth: "1200px", margin: "0 auto" }}>
        {blogPosts.length === 0 ? (
          <div style={{ textAlign: "center", padding: "80px 0" }}>
            <h2 className="font-dm-serif" style={{ fontSize: "28px", color: C.text, marginBottom: "14px" }}>No posts yet</h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: "24px" }}>
            {blogPosts.map((post: BlogPost) => (
              <div key={post.id} className="group" style={{ background: C.cream, borderRadius: "16px", overflow: "hidden", border: "1px solid rgba(42,38,32,0.08)" }}>
                ...
                <div style={{ padding: "20px 22px 22px" }}>
                  <h2 className="font-dm-serif" style={{ fontSize: "20px", color: C.text, marginBottom: "10px", lineHeight: 1.25 }}>
                    {post.title}
                  </h2>
                  ...
                  <div style={{ borderTop: "1px solid rgba(42,38,32,0.08)", paddingTop: "14px", display: "flex", justifyContent: "flex-end" }}>
      ...
      <section style={{ background: C.dark, color: "white", padding: "80px 48px" }}>
        <div style={{ maxWidth: "540px", margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 className="font-dm-serif" style={{ fontSize: "36px", letterSpacing: "-0.02em", marginBottom: "16px" }}>
            Stay Updated
          </h2>
