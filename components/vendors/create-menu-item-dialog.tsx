...
export function CreateMenuItemDialog({ open, onOpenChange, onSuccess }: Props) {
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto bg-white">
        <DialogHeader>
          ...
          <DialogDescription className="font-poppins text-sm">
            Fill in the details to add a single menu item.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className="font-poppins"
              />
              {categoryOpen && formData.category !== "" && (
                <div className="absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-md shadow-lg max-h-60 overflow-auto">
                  {CATEGORIES.filter((cat) =>
                    ...
                    <div className="py-2 px-3 text-sm font-poppins text-gray-500">
                      Press Enter to use &quot;{formData.category}&quot;
                    </div>
                  )}
                </div>
              )}
        ...
        <DialogFooter className="gap-2">
          ...
          <Button
            ...
            className="bg-gray-900 hover:bg-gray-700 text-white font-poppins"
            disabled={isSubmitting}
          >
            {isSubmitting ? (
              <>
