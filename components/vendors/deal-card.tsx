  ...
  return (
    <div className="group flex bg-white border border-gray-100 rounded-2xl overflow-hidden hover:border-gray-200 hover:shadow-md transition-all duration-200 w-full">
      ...
      <div className="hidden sm:block relative w-44 lg:w-52 flex-shrink-0 bg-gray-50">
        ...
        {/* Priority pill overlaid on image */}
          ...
          {(deal.startDate || deal.endDate) && (
            <>
              ...
              <div className="flex items-center gap-1.5">
                <CalendarRange className="w-3 h-3 flex-shrink-0 text-gray-400" />
                <span className="font-poppins text-xs text-gray-500">
                  {deal.startDate
          ...
          {deal.tags && deal.tags.length > 0 && (
            <>
              ...
              <div className="flex items-center gap-1.5 text-gray-400">
                ...
                <span className="font-poppins text-xs text-gray-500 truncate max-w-[160px]">
                  {deal.tags.slice(0, 3).join(", ")}
                  {deal.tags.length > 3 ? ` +${deal.tags.length - 3}` : ""}
                </span>
              </div>
            </>
          )}
